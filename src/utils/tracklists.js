  ...
  switch (album) {
    case 'fireworks':
      return {
        ...
        tracks: ['Diana Slowburner II  5:23',
            'On My Way  9:51',
            'Gone to Earth  7:03',
    ...
    case 'livingroom':
      return {
        ...
        tracks: ['Magnificent Seventies  8:57',
    ...
    case 'promiseoflove':
      return {
        ...
        tracks: ['Continuous Hit Music  4:27',
            'Hard to Find  4:17',
